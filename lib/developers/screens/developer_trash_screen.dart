...
class DeveloperTrashScreen extends StatelessWidget {
  const DeveloperTrashScreen({Key? key}) : super(key: key);
...
/*
  ...
  */
  ...
  Widget build(BuildContext context) {
    print("build developer trash screen");
            ...
            appBar: AppBar(
              ...
              actions: [
                ...
                UserInformation(
                  ...
                  returnPageRouteName: DeveloperTrashScreen.routeName,
                ),
              ],
            ),
