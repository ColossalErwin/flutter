...
//deep copy
  ...
  void _manageImageURLs(List<bool> deletedIndices) {
    ...
    for (int i = deletedIndices.length - 1; i >= 0; i--) {
      ...
      //https://firebasestorage.googleapis.com/v0/b/my-backlog-1040f.appspot.com/o/users%2FvRzo1kGFObWY9yrpgs4Ne6roY0p1       %2Fgames%2FTimestamp(seconds%3D1662003845%2C%20nanoseconds%3D959119000)%2FimageURLs%2FTimestamp(seconds%3D1662003847%2C%20nanoseconds%3D172432000)?alt=media&token=ae0be72c-0dca-4f44-bd3f-7c014bd57a54
      //https://firebasestorage.googleapis.com/v0/b/my-backlog-1040f.appspot.com/o/users%2FvRzo1kGFObWY9yrpgs4Ne6roY0p1       %2Fgames%2FTimestamp(seconds%3D1661786037%2C%20nanoseconds%3D327339000)%2FimageURLs%2FTimestamp(seconds%3D1662009162%2C%20nanoseconds%3D745436000)?alt=media&token=88ffbc5d-e87f-46e6-88a6-620f40d40453
    }
    setState(() {});
  }
